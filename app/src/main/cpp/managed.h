...
typedef MonoEmbedObject Arrays_ArrayTypes;
...
MONO_EMBEDDINATOR_API int32_t Arrays_ArrayTypes_SumByteArray(_UnsignedcharArray array);
MONO_EMBEDDINATOR_API _IntArray Arrays_ArrayTypes_ReturnsIntArray();
MONO_EMBEDDINATOR_API _StringArray Arrays_ArrayTypes_ReturnsStringArray();
