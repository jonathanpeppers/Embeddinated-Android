...
static MonoClass* class_Arrays_ArrayTypes = 0;
...
static void __lookup_class_Arrays_ArrayTypes()
{
    if (class_Arrays_ArrayTypes == 0)
    {
        __initialize_mono();
        __lookup_assembly_managed_dll();
        class_Arrays_ArrayTypes = mono_class_from_name(__managed_dll_image, "Arrays", "ArrayTypes");
    }
}

int32_t Arrays_ArrayTypes_SumByteArray(_UnsignedcharArray array)
{
    const char __method_name[] = "Arrays.ArrayTypes:SumByteArray(byte[])";
    static MonoMethod *__method = 0;

    if (!__method)
    {
        __lookup_class_Arrays_ArrayTypes();
        __method = mono_embeddinator_lookup_method(__method_name, class_Arrays_ArrayTypes);
    }
...
_IntArray Arrays_ArrayTypes_ReturnsIntArray()
{
    const char __method_name[] = "Arrays.ArrayTypes:ReturnsIntArray()";
    static MonoMethod *__method = 0;
...
_StringArray Arrays_ArrayTypes_ReturnsStringArray()
{
    const char __method_name[] = "Arrays.ArrayTypes:ReturnsStringArray()";
    static MonoMethod *__method = 0;
