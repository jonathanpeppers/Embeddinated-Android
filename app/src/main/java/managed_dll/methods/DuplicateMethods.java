...
public class DuplicateMethods {
    ...
    public int doIt_1(int i) {
        int __ret = managed_dll.Native_managed_dll.INSTANCE.Methods_DuplicateMethods_DoIt_1(__object, i);
        mono.embeddinator.Runtime.checkExceptions();
        return __ret;
    }

    public int doIt_2(String s) {
        int __ret = managed_dll.Native_managed_dll.INSTANCE.Methods_DuplicateMethods_DoIt_2(__object, s);
        mono.embeddinator.Runtime.checkExceptions();
        return __ret;
    }

    public int doIt_3(int i, int j) {
        int __ret = managed_dll.Native_managed_dll.INSTANCE.Methods_DuplicateMethods_DoIt_3(__object, i, j);
        mono.embeddinator.Runtime.checkExceptions();
        return __ret;
    }
    ...
    public boolean find_1(String firstName, String lastName) {
        byte __ret = managed_dll.Native_managed_dll.INSTANCE.Methods_DuplicateMethods_Find_1(__object, firstName, lastName);
        mono.embeddinator.Runtime.checkExceptions();
        return __ret != 0;
    }
}
