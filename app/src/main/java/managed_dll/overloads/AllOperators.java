...
public class AllOperators {
    ...
    public static managed_dll.overloads.AllOperators opDivision_1(managed_dll.overloads.AllOperators c1, int c2) {
        com.sun.jna.Pointer __ret = managed_dll.Native_managed_dll.INSTANCE.Overloads_AllOperators_op_Division_1(c1 == null ? null : c1.__object, c2);
        mono.embeddinator.Runtime.checkExceptions();
        return (__ret == com.sun.jna.Pointer.NULL ? null : new managed_dll.overloads.AllOperators(__ret));
    }

    public static managed_dll.overloads.AllOperators opDivision_2(int c1, managed_dll.overloads.AllOperators c2) {
        com.sun.jna.Pointer __ret = managed_dll.Native_managed_dll.INSTANCE.Overloads_AllOperators_op_Division_2(c1, c2 == null ? null : c2.__object);
        mono.embeddinator.Runtime.checkExceptions();
        return (__ret == com.sun.jna.Pointer.NULL ? null : new managed_dll.overloads.AllOperators(__ret));
    }

    public static managed_dll.overloads.AllOperators opDivision_3(managed_dll.overloads.AllOperators c1, long c2) {
        com.sun.jna.Pointer __ret = managed_dll.Native_managed_dll.INSTANCE.Overloads_AllOperators_op_Division_3(c1 == null ? null : c1.__object, c2);
        mono.embeddinator.Runtime.checkExceptions();
        return (__ret == com.sun.jna.Pointer.NULL ? null : new managed_dll.overloads.AllOperators(__ret));
    }
    ...
    public static managed_dll.overloads.AllOperators opBitwiseAnd_1(managed_dll.overloads.AllOperators c1, int c2) {
        com.sun.jna.Pointer __ret = managed_dll.Native_managed_dll.INSTANCE.Overloads_AllOperators_op_BitwiseAnd_1(c1 == null ? null : c1.__object, c2);
        mono.embeddinator.Runtime.checkExceptions();
        return (__ret == com.sun.jna.Pointer.NULL ? null : new managed_dll.overloads.AllOperators(__ret));
    }
